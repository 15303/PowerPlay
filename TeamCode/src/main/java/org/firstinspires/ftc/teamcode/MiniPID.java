...
public class MiniPID{
	...
	private Deque<Double> lastActuals = new ArrayDeque<>();
	...
	public double getOutput(double actual, double setpoint){
		...
		Doutput= -D*(actual-lastActuals.getFirst());
		lastActuals.removeFirst();
		lastActuals.addLast(actual);
